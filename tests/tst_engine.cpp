...
void TestsEngine::test_setStartingArrangement() {
  ...
  QCOMPARE(engine.getData()[1][7]->getTypeFigure(), W_BISHOP);
  QCOMPARE(engine.getData()[1][0]->getTypeFigure(), B_BISHOP);
  QCOMPARE(engine.getData()[6][7]->getTypeFigure(), W_BISHOP);
  QCOMPARE(engine.getData()[6][0]->getTypeFigure(), B_BISHOP);

  QCOMPARE(engine.getData()[2][7]->getTypeFigure(), W_KNIGHT);
  QCOMPARE(engine.getData()[2][0]->getTypeFigure(), B_KNIGHT);
  QCOMPARE(engine.getData()[5][7]->getTypeFigure(), W_KNIGHT);
  QCOMPARE(engine.getData()[5][0]->getTypeFigure(), B_KNIGHT);

  QCOMPARE(engine.getData()[4][7]->getTypeFigure(), W_QUEEN);
  QCOMPARE(engine.getData()[3][0]->getTypeFigure(), B_QUEEN);

  QCOMPARE(engine.getData()[3][7]->getTypeFigure(), W_KING);
