...
MainWindow::MainWindow(QWidget *parent)
  ...
  connect(&screen_settings, SIGNAL(changeMusicFlag(bool)), &storage_settings,
          SLOT(changeMusicFlag(bool)));
  connect(&screen_settings, SIGNAL(changeSoundsFlag(bool)), &storage_settings,
          SLOT(changeSoundsFlag(bool)));
  connect(&screen_settings, SIGNAL(changeMusicVolume(int)), &storage_settings,
          SLOT(changeMusicVolume(int)));
  connect(&screen_settings, SIGNAL(changeSoundsVolume(int)), &storage_settings,
          SLOT(changeSoundsVolume(int)));
}
