...
При ходе на поле, занятое чужой фигурой [вес Вашей фигуры](#типы-фигур-и-их-вес) расчитывается следующим образом:  
...
Данные правила пременимы ко всем фигурам, кроме короля. Если Ваш король находится в зоне хода фигуры противника вы должны сделать ход в такую клетку, в которой король не находится в зоне атаки фигуры противника. Если Вы не можете сделать такого хода - Вы проиграли.
