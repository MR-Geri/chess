...
##### close
Закрытие окна, активным становится окно Menu.
...
#### Menu
##### start
Запуск меню, обновление таблицы лидеров (reload_lider_board).

##### reload_lider_board
Обновление таблицы лидеров. Вызывается при каждом активировании окна меню.
...
#### Settings
##### close
Закрытие окна настроек, активным становится или окно Game, или окно Menu (в зависимости от окна, из которого были открыты настройки).
...
### Board
#### delete_figure
Удалить фигуру с поля и начислить очки игроку, взявшему данную фигуру.

#### change_figure
Изменить пешку на выбранную пользователем фигуру.
...
##### stop
Закончить воспроизводить музыку.

##### set_track
Установить музыкальный файл для воспроизведения.
